...
function newspark_enqueue() {
		...
		wp_enqueue_script( 'isotope', get_template_directory_uri()."/script/external/isotope/jquery.isotope.min.js" );
		wp_enqueue_script( 'browser', get_stylesheet_directory_uri()."/component/browser/script/browser.js", array("isotope") );
